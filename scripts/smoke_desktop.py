...
window.platform.upload_config_dialog.show()
QTest.qWait(100)
window.platform.upload_config_dialog.grab().save(str(folder.parent / "upload-config.png"))
window.platform.upload_config_dialog.close()
window.navigation.setCurrentRow(0)
